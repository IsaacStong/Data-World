...
class oracleInsert():
    ...
    def createpage(self):
        ...
        def insert():
            try:
                DBconnect.OracleDB().insert(var.get(), command.get())
                top= Toplevel(window)
        ...
        def getColumns():
            col_list = DBconnect.OracleDB().getColumns(var.get())
        ...
        welcome = Label(header, text="Oracle Table Inserter", bg='dark gray')
